...
public class MainKH extends javax.swing.JFrame {
    ...
    public MainKH(ModelUser user) {
        ...
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/Icons/3.png")));
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/Icons/user (2).png")));
        navigationBar1.addEvent(new EventNavigationBar(){
            @Override
            public void beforeSelected(int index) {
                switch (index) {
                    case 0:
                        panelTransaction1.display(new Form1(user), navigationBar1.getAnimator());
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        panelTransaction1.display(new Form4(user), navigationBar1.getAnimator());
                        break;
                    case 4:
                        panelTransaction1.display(new Form5(user), navigationBar1.getAnimator());
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(panelTransaction1, javax.swing.GroupLayout.DEFAULT_SIZE, 531, Short.MAX_VALUE)
                .addGap(0, 0, 0)
