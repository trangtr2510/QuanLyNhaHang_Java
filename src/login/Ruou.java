 ...
 * @author PC
 */
public class Ruou extends javax.swing.JFrame {

    private final ModelUser user = null;
    public Ruou(ModelUser user) {
        initComponents();
    ...
    public static void main(ModelUser user) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ruou.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
