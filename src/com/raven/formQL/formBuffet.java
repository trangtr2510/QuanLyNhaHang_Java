...
public class formBuffet extends javax.swing.JPanel {

    final String header[] = {"Mã Buffet", "Tên Buffet", "Mô tả", "Giá"};//tieu de cua bang
    ...
    public void loadBang() {
        try {
            ...
            String sql = "select * from QLBuffet";//cau truy van
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh sách Buffet");

        jLabel2.setText("Tìm kiếm theo tên Buffet:");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtMota, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtTK, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)))))
        ...
        dgwND.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dgwNDMouseClicked(evt);
            }
        });
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
         try {
            ...
            if (!checkValidate()) {
                ...
                String idTD = service.getIDBuffet();
                ...
                int idBuffet = Integer.parseInt(idTD);
                // các thông tin thêm
                mdb.setMaBuffet(idBuffet);
                mdb.setTenBuffet(txtName.getText());
                mdb.setGia(Float.parseFloat(txtGia.getText()));
                // Kiểm tra trùng lặp và thực hiện thêm
                try {
                    if (service.checkDuplicateBuffetID(mdb.getMaBuffet())) {
                        showMessage(Message.MessageType.ERROR, "Mã Buffet đã tồn tại. ");
                    } else {
                        service.insertBuffet(mdb);
                        showMessage(Message.MessageType.SUCCESS, "Thêm Buffet thành công.");
                        resetForm();
                    }
                } catch (Exception e) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Vui lòng chọn Buffet để xóa!", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            } else {
                int ck = JOptionPane.showConfirmDialog(this, "Bạn chắc chắn muốn xóa Buffet này?", "Thông báo", JOptionPane.YES_NO_OPTION);
                if (ck == JOptionPane.YES_OPTION) {
                    String maPNString = (String) dgwND.getValueAt(selectedRow, 0);
                    int maPN = Integer.parseInt(maPNString);
                    service.deleteBuffet(maPN);
                    resetForm();
                    showMessage(Message.MessageType.SUCCESS, "Xóa Buffet thành công.");//thong báo thành công
                }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try {
            ...
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Vui lòng chọn Buffet muốn cập nhật!", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            } else {
                try {
                    String maPNString = (String) dgwND.getValueAt(selectedRow, 0);
                    int maPN = Integer.parseInt(maPNString);
                    mdb.setMaBuffet(maPN);
                    mdb.setTenBuffet(txtName.getText());
                    mdb.setMoTa(txtMota.getText());
                    mdb.setGia(Float.parseFloat(txtGia.getText()));
                    service.updateBuffet(mdb);
                    resetForm();
                    showMessage(Message.MessageType.SUCCESS, "Cập nhật thành công.");
                } catch (Exception e) {
                    showMessage(Message.MessageType.ERROR, "Lỗi khi cập nhật.");
                    e.printStackTrace();
                }
            }
        } catch (Exception e) {
...
//        resetForm();
    ...
    private void dgwNDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dgwNDMouseClicked
         int x = dgwND.getSelectedRow();
        if (x >= 0) {
            txtName.setText(dgwND.getValueAt(dgwND.getSelectedRow(), 1) + "");
            txtMota.setText(dgwND.getValueAt(dgwND.getSelectedRow(), 2) + "");
            txtGia.setText(dgwND.getValueAt(dgwND.getSelectedRow(), 3) + "");
        }
    }//GEN-LAST:event_dgwNDMouseClicked
