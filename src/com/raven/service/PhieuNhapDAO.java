...
public class PhieuNhapDAO implements DAOInterface<ModelPhieuNhap> {
    ...
    public int insert(ModelPhieuNhap t) {
        ...
        try {
            ...
            String sql = "INSERT INTO PhieuNhap (MaPN, NgayNhap, ID_ND, TongTien) VALUES (?, ?, ?, ?)";
    ...
    public int update(ModelPhieuNhap t) {
        ...
        try {
            Connection con = DatabaseConnection.getInstance().getConnection();
            String sql = "UPDATE PhieuNhap SET NgayNhap = ?, ID_ND = ?, TongTien = ? WHERE MaPN = ?";
            PreparedStatement pst = con.prepareStatement(sql);
