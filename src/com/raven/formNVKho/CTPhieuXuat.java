...
public class CTPhieuXuat extends javax.swing.JDialog {
    ...
    final String header[] = {"STT", "Mã phiếu Xuất", "Mã nguyên liệu", "Tên nguyên liệu", "Nhà cung cấp", "Đơn vị tính", "Hạn sử dụng",
        "Số lượng", "Giá"};
    ...
    public CTPhieuXuat(int mapn) throws SQLException {
    ...
    public void loadBang(int mapn) {
        try (Connection connection = cn.getConnection(); // Kết nối cơ sở dữ liệu
                 PreparedStatement pst = connection.prepareStatement(
                        ...
                        + "CT.MaPX, CT.MaNL, CT.SoLuong, CT.DonGia "
            ...
            while (rs.next()) {
                ...
                row.add(rs.getString("MaPX")); // Mã phiếu nhập
    ...
    public void hienThiThongTinPhieuNhap(String idPN) {
        try (Connection connection = cn.getConnection()) {
            ...
            phieuNhap = service.selectByIdPX(idPN);
            ...
            if (phieuNhap != null) {
                ...
                JOptionPane.showMessageDialog(null, "Không tìm thấy thông tin phiếu xuất!", "Thông báo", JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Đã xảy ra lỗi khi lấy thông tin phiếu xuất!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    }
