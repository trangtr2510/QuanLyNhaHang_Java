...
public class formPhieuNhap extends javax.swing.JPanel {
    ...
    final String header[] = {"Mã phiếu nhập", "Ngày nhập", "Mã người nhập(Người dùng)", "Tổng tiền"};
    DefaultTableModel tb = new DefaultTableModel(header, 0);
    int q, i;
    DatabaseConnection cn = new DatabaseConnection();
    private Connection connection;

    public formPhieuNhap(ModelUser user) {
    ...
    public void searchByDateRange() {
        ...
        try {
            ...
            // Câu truy vấn SQL
            String sql = "SELECT * FROM phieunhap WHERE ngayNhap BETWEEN '" + fromDateFormatted + "' AND '" + toDateFormatted + "'";
    ...
    public void filterByPriceRange() {
        ...
        try {
            ...
            // Câu truy vấn SQL
            String sql = "SELECT * FROM phieunhap WHERE tongTien BETWEEN " + minPrice + " AND " + maxPrice;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try (Connection conn = DatabaseConnection.getInstance().getConnection()) {
            ...
            formNhapNL formNhap = new formNhapNL(user);  // Truyền đối tượng user vào form
    ...
    private void btnDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailActionPerformed
        try (Connection conn = DatabaseConnection.getInstance().getConnection()) {
            if (tblPhieuNhap.getSelectedRow() == -1) {
                ...
                CTPhieuNhap detailDialog = new CTPhieuNhap(idpn);
