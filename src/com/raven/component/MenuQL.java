...
public class MenuQL extends javax.swing.JPanel {
    ...
    public void initMenu(EventMenu event) {
        ...
        addMenu(new ImageIcon(getClass().getResource("/Icons/8.png")), "Đặt bàn", 1);
        addMenu(new ImageIcon(getClass().getResource("/Icons/menu (2).png")), "Quản lý thực đơn", 2);
        addMenu(new ImageIcon(getClass().getResource("/Icons/bell-boy (1).png")), "Quản lý nhân viên", 3);
