...
public class Menu extends javax.swing.JPanel {
    ...
    public void displayUserInfo(ModelUser user) {
        ...
        try {
            ...
            if (rs.next()) {
                jLabel1.setText(rs.getString("tennv"));
    ...
    public void initMenu(EventMenu event) {
        ...
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Menu", 2);
        ...
        addEmpty();
        addMenu(new ImageIcon(getClass().getResource("/Icons/10.png")), "Logout", 8);
    }
