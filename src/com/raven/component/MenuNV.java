...
public class MenuNV extends javax.swing.JPanel {
    ...
    public void initMenu(EventMenu event) {
        this.event = event;
        addMenu(new ImageIcon(getClass().getResource("/Icons/8.png")), "Đặt bàn", 0);
        addMenu(new ImageIcon(getClass().getResource("/Icons/customer.png")), "Danh sách khách hàng", 1);
        addMenu(new ImageIcon(getClass().getResource("/Icons/selling.png")), "Danh sách mã khuyến mại", 2);
        addMenu(new ImageIcon(getClass().getResource("/Icons/inventory (1).png")), "Cập nhật hóa đơn", 3);
//        addMenu(new ImageIcon(getClass().getResource("/Icons/8.png")), "Danh sách đặt bàn", 4);
