...
public class MenuKH extends javax.swing.JPanel {
    ...
    public void displayUserInfo(ModelUser user) {
        ...
        try {
            ...
            if (rs.next()) {
                jLabel1.setText(rs.getString("tenKH"));
                jLabel2.setText(rs.getString("vaitro"));
            }
    ...
    public void initMenu(EventMenu event) {
        this.event = event;
        //addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Thống kê", 0);
        addMenu(new ImageIcon(getClass().getResource("/Icons/8.png")), "Đặt bàn", 0);
        addMenu(new ImageIcon(getClass().getResource("/Icons/menu (2).png")), "Menu", 1);
        addMenu(new ImageIcon(getClass().getResource("/Icons/bell-boy (1).png")), "About us", 2);
